...
(function formRepeatable() {
  ...
  // Disabled one-var and func-names for better readability

  // Splits the string and pops the last element
  var splitPop = function (input, splitter) {  // eslint-disable-line func-names
  ...
  var updateIdsAndInputs = function (id, oldId) {  // eslint-disable-line one-var, func-names
  ...
  var decrementHtmlFor = function (node) {  // eslint-disable-line one-var, func-names
    var child = node,
  ...
  var decrementId = function (node) {  // eslint-disable-line one-var, func-names
    var child = node,
  ...
  var decrementName = function (node) {  // eslint-disable-line one-var, func-names
    var child = node,
  ...
  // Updates node
  var updateNode = function (key) {  // eslint-disable-line one-var, func-names
    var child = key;
  ...
  var deleteIdsAndInputs = function (nodes) {  // eslint-disable-line one-var, func-names
  ...
  var updateInstance = function (instance) {  // eslint-disable-line one-var, func-names
    ...
    node.id = nodeId.join('--');
    childNodes.forEach(updateNode);
  };

  // Removes indexing from instance
  var removeIndex = function (instance) {  // eslint-disable-line one-var, func-names
  ...
  var deleteHandler = function deleteEventHandler(e) {  // eslint-disable-line one-var, func-names
  ...
  var setIDsAndInputs = function (idMap) {  // eslint-disable-line one-var, func-names
  ...
  var newDeleteButton = function (attribute) {  // eslint-disable-line one-var, func-names
  ...
  var updateCurrentInstance = function (instance, attribute) {  // eslint-disable-line one-var, func-names
    var container = instance,
    ...
    container.querySelectorAll('*').forEach(function setAttributes(node) {
      var child = node,
          oldChildId;
      if (child.id !== '') {
        oldChildId = child.id;
  ...
  // Adds index to id
  var setId = function (node, map, index) {  // eslint-disable-line one-var, func-names
    var child = node,
        idMap = map;
  ...
  var setHtmlFor = function (node, map, index) {  // eslint-disable-line one-var, func-names
    var child = node,
        idMap = map;
  ...
  var setName = function (node, index) {  // eslint-disable-line one-var, func-names
    var child = node,
        childName = child.getAttribute('name');
    if (childName) {
  ...
  var clearValues = function (node) {  // eslint-disable-line one-var, func-names
    var child = node;
  ...
  var newInstance = function (instance, map, index) { // eslint-disable-line one-var, func-names
    var idMap = map,
        container = instance,
        firstInput;
    ...
    container.querySelectorAll('*').forEach(function cloneAttribute(child) {
      if (child.id !== '') {
        setName(child, index);
  ...
  var addNewContainer = function (container, newContainer) { // eslint-disable-line one-var, func-names
  ...
  var addHandler = function (e) { // eslint-disable-line one-var, func-names
    var firstInput,
  ...
  Object.keys(allSettings).forEach(function repeatableHandler(input) {
    ...
    document.querySelectorAll('.form--delete').forEach(function addsDeleteEvent(button) {
